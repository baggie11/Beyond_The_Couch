...
const StorybookInitiative = () => {
  return (
    <>
      {/* Add this Head component if using Next.js */}
      <Head>
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
      </Head>

      <div className="min-h-[100dvh] bg-white w-full overflow-x-hidden py-12 px-4 sm:px-6 lg:px-8">
        {/* Hero Section */}
        <motion.div 
          initial="hidden"
          animate="visible"
        ...
        >
          <motion.h1 variants={itemVariants} className="text-4xl md:text-5xl font-bold text-[#5c6650] mb-6">
            Illustrated Storybooks for Young Minds
          </motion.h1>
          <motion.p variants={itemVariants} className="text-lg md:text-xl text-[#5c6650]/80 max-w-3xl mx-auto">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          variants={containerVariants}
          className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20 px-4"
        >
          {[
            {
              title: "Target Group",
        ...
        <div className="max-w-6xl mx-auto mb-20 px-4">
          ...
          >
            ...
            >
              <div className="relative overflow-hidden rounded-2xl shadow-xl aspect-[4/5] bg-gray-100"> {/* Added bg-gray-100 as fallback */}
                <motion.img 
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          variants={containerVariants}
          className="max-w-6xl mx-auto bg-[#5c6650]/5 p-6 md:p-8 rounded-2xl mb-20 mx-4"
        >
          <motion.h2 
            variants={itemVariants}
